...
public class CostStrategy implements CostStrategyInter {
    ...
    @Override
    public double calculateFee(VehicleType type, int hour) throws ParkingLotException {
        ...
        return hourlyRate * hour; // Simple calculation: hourly rate multiplied by hours parked
    }
